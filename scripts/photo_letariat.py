...
# that takes advantage of the fact that we already have most of the information we need to make the necessary
# modifications, notably the file name and file path
