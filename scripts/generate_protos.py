...
def generate_protos_and_replace_import(proto_directory, files_out_location, proto_file) -> None:
...
if __name__ == "__main__":
    ...
    generate_protos_and_replace_import(proto_directory_arg, files_out_arg, proto_file_arg)
