...
class AiModelOutputRequest(_message.Message):
    ...
    blur_value: float
    similarity_output: _containers.RepeatedCompositeFieldContainer[FaceExtractOutput]
    def __init__(self, photo_id: _Optional[str] = ..., project_table_name: _Optional[str] = ..., image_comparison_run_id: _Optional[str] = ..., image_comparison_name: _Optional[str] = ..., image_comparison_datatype: _Optional[str] = ..., image_comparison_shape: _Optional[int] = ..., average_hash: _Optional[bytes] = ..., perceptual_hash: _Optional[bytes] = ..., difference_hash: _Optional[bytes] = ..., wavelet_hash_haar: _Optional[bytes] = ..., color_hash: _Optional[bytes] = ..., color_averages: _Optional[str] = ..., bounding_boxes_from_faces_model: _Optional[str] = ..., number_of_faces: _Optional[int] = ..., labels_from_classifications_model: _Optional[_Iterable[bytes]] = ..., blur_value: _Optional[float] = ..., similarity_output: _Optional[_Iterable[_Union[FaceExtractOutput, _Mapping]]] = ...) -> None: ...

class FaceExtractOutput(_message.Message):
    __slots__ = ("pixel", "value")
    PIXEL_FIELD_NUMBER: _ClassVar[int]
    VALUE_FIELD_NUMBER: _ClassVar[int]
    pixel: str
    value: float
    def __init__(self, pixel: _Optional[str] = ..., value: _Optional[float] = ...) -> None: ...
